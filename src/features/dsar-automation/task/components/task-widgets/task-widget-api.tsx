        ...
        >
          ...
          >
            ...
            >
              <Switch
                checkedChildren={
                  <IntlMessage id="dsarAutomation.request.detail.task.assign.api.on" />
                }
                unCheckedChildren={
                  <IntlMessage id="dsarAutomation.request.detail.task.assign.api.off" />
                }
              />
            </Form.Item>
          </div>
          ...
          return (
            <>
              ...
              >
                <Form.Item
                  label={
                    <IntlMessage id="dsarAutomation.request.detail.task.assign.api.apiURL" />
                  }
                  name="apiURL"
                  className="w-100"
                  rules={[
                    validation.required(
                      t(
                        'dsarAutomation.request.detail.task.assign.api.apiURL.validate'
                      )
                    ),
                    validation.url(),
                  ]}
                ...
                <Form.Item style={{ marginTop: 30 }}>
                  ...
                  >
                    {readOnly ? (
                      <IntlMessage id="dsarAutomation.request.detail.task.assign.api.receive" />
                    ) : (
                      <IntlMessage id="dsarAutomation.request.detail.task.assign.api.test" />
                    )}
                  </Button>
                </Form.Item>
              </Flex>
              <Typography className="mb-2">
                <IntlMessage id="dsarAutomation.request.detail.task.assign.api.log" />
              </Typography>
