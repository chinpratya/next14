...
export const WorkFlowList = () => {
  ...
  const deletePermission = usePermission({
    moduleName: 'dsar',
    policies: [
      permissions['pdpakit:dsar:workflow:delete'],
    ],
  });
  ...
  const deleteWorkflow = useDeleteWorkflow({
    onSuccess: () => {
      showNotification({
        type: 'success',
        message: t(
          'dsarAutomation.notification.workflow.delete'
        ) as string,
      });
      toggle.remove();
    },
  ...
  const columns: ColumnsType<Workflow> = [
    {
      title: (
        <IntlMessage id="dsarAutomation.setting.workflow.name" />
      ),
      key: 'name',
      width: 250,
      ellipsis: true,
    ...
    {
      title: (
        <IntlMessage id="dsarAutomation.setting.workflow.status" />
      ),
      dataIndex: 'status',
      key: 'status',
      width: 100,
    ...
    {
      title: (
        <IntlMessage id="dsarAutomation.setting.workflow.version" />
      ),
      dataIndex: 'version',
      key: 'version',
      width: 80,
    ...
    {
      title: (
        <IntlMessage id="dsarAutomation.setting.workflow.createdDt" />
      ),
      dataIndex: 'createdDt',
      key: 'createdDt',
      width: 130,
    ...
    {
      title: (
        <IntlMessage id="dsarAutomation.setting.workflow.updatedDt" />
      ),
      dataIndex: 'updatedDt',
      key: 'updatedDt',
      width: 130,
    ...
    {
      title: (
        <IntlMessage id="dsarAutomation.setting.workflow.tag" />
      ),
      dataIndex: 'tagName',
      key: 'tags',
      width: 150,
      ...
      render: (Workflow: Workflow) => (
        <DropdownTable
          items={[
            {
              label: (
                <IntlMessage id="dsarAutomation.setting.workflow.edit" />
              ),
              key: 'edit',
              icon: <EditOutlined />,
              onClick: () => onEdit(Workflow),
            ...
            {
              label: (
                <IntlMessage id="dsarAutomation.setting.workflow.delete" />
              ),
              key: 'delete',
              icon: <DeleteOutlined />,
