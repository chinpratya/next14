...
export const RightsStageModal = ({
  ...
  const title = isEdit ? (
    <IntlMessage id="dsarAutomation.setting.workflow.detail.workflow.edit" />
  ) : (
  ...
  const createStage = useCreateWorkflowStage({
    ...
    onSuccess: () => {
      showNotification({
        type: 'success',
        message: t(
          'dsarAutomation.notification.workflow.stage.add'
        ) as string,
      });
      onClose();
    },
  ...
  const updateStage = useUpdateWorkflowStage({
    ...
    onSuccess: () => {
      showNotification({
        type: 'success',
        message: t(
          'dsarAutomation.notification.workflow.stage.update'
        ) as string,
      });
      onClose();
    },
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical">
        <Form.Item
          label={
            <IntlMessage id="dsarAutomation.setting.workflow.detail.workflow.name" />
          }
          name="name"
          rules={[
            validation.required(
              t(
                'dsarAutomation.setting.workflow.detail.workflow.nameRequired'
              )
            ),
          ]}
        >
              ...
              <>
                ...
                >
                  ...
                  >
                    <Switch
                      checkedChildren={
                        <IntlMessage id="dsarAutomation.setting.workflow.detail.on" />
                      }
                      unCheckedChildren={
                        <IntlMessage id="dsarAutomation.setting.workflow.detail.off" />
                      }
                    />
                  </Form.Item>
                </Flex>
