...
export const NotificationSettingTable = ({
  ...
  const deletePermission = usePermission({
    ...
    policies: [
      permissions[
        'cyber:siem:notification-setting:delete'
      ],
    ],
  });
  ...
  const columns: ColumnsType<Notify> = [
    {
      key: 'name',
      title: (
        <IntlMessage id="siem.notificationSetting.name" />
      ),
      width: 150,
      render: (data: Notify) => (
        <Typography.Link
    ...
    },
    {
      key: 'type',
      title: (
        <IntlMessage id="siem.notificationSetting.type" />
      ),
      dataIndex: 'provider',
      width: 70,
    ...
    },
    {
      key: 'createdDate',
      title: (
        <IntlMessage id="siem.notificationSetting.createdDate" />
      ),
    ...
    },
    {
      key: 'createdBy',
      title: (
        <IntlMessage id="siem.notificationSetting.createdBy" />
      ),
      align: 'center',
      width: 100,
      render: (data: Notify) => (
      ...
      render: (data: Notify) => (
        <DropdownTable
          items={[
            {
              key: 'edit',
              label: <IntlMessage id="siem.edit" />,
              icon: <EditOutlined />,
            ...
            {
              key: 'duplicate',
              label: <IntlMessage id="siem.duplicate" />,
              icon: <CopyOutlined />,
              disabled:
            ...
            {
              key: 'delete',
              label: <IntlMessage id="siem.delete" />,
              icon: <DeleteOutlined />,
              disabled:
                data.provider === 'DEFAULT' ||
