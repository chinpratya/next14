...
export const UnresolvedIncidentSchema = z.object({
  id: z.string(),
  indices: z.string(),
  rule_name: z.string(),
  severity: z.string(),
...
export const UnresolvedIncidentResponseSchema = z.array(
...
export const EventSummaryOrganizationSchema = z.object({
  avg: z.number(),
  max: z.number(),
  min: z.number(),
  sum: z.number(),
