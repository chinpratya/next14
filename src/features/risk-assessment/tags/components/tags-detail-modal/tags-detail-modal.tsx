  ...
  const updateTag = useUpdateTag({
    ...
    onSuccess: () => {
      ...
      showNotification({
        type: 'success',
        message: t(
          tokens.riskAssessment.tags.notifications.update
        ) as string,
      });
    },
  });
  ...
  const tabItems: TabsProps['items'] = [
    {
      label: (
        <IntlMessage
          id={tokens.riskAssessment.tags.detail}
        />
      ),
      key: 'detail',
    ...
    },
    {
      label: (
        <IntlMessage
          id={tokens.riskAssessment.tags.basicInfo}
        />
      ),
      key: 'basic',
      children: (
  ...
  return (
    <Modal
      ...
      title={
        <>
          <IntlMessage
            id={tokens.riskAssessment.tags.detailTitle}
          />{' '}
