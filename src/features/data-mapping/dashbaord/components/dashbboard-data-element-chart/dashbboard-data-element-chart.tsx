...
import { useGetDashboardGraphDataElement } from '../../api/get-dashboard-graph-data-element';

export const DashboardDataElementChart = () => {
  const { data, isLoading, isError } =
    useGetDashboardGraphDataElement();
  ...
  return (
    <FallbackError isError={isError}>
      <Card
        title={
          <IntlMessage id="dataMapping.dashboard.dataElement" />
        }
        loading={isLoading}
        extra={
          <Flex
      ...
      >
        ...
        >
          {_.map(modifyData, (v) => {
            const index = v.indexKey.indexOf('#');
