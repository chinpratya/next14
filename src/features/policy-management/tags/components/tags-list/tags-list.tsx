...
export const TagsList = () => {
  ...
  const deleteTag = useDeleteTag({
    onSuccess: () => {
      ...
      showNotification({
        type: 'success',
        message: t(
          'policyManagement.notification.tags.delete'
        ) as string,
      });
    },
  });
  ...
  const actionRender = (data: Tag) => (
    <DropdownTable
      items={[
        {
          label: (
            <IntlMessage id="policyManagement.tag.edit" />
          ),
          key: 'edit',
          icon: <EditOutlined />,
        ...
        {
          label: (
            <IntlMessage id="policyManagement.tag.delete" />
          ),
          key: 'delete',
          icon: <DeleteOutlined />,
  ...
  const columns = [
    {
      title: <IntlMessage id="policyManagement.tag.Id" />,
      key: 'tagId',
      width: 200,
      ellipsis: true,
      render: (data: Tag) => (
