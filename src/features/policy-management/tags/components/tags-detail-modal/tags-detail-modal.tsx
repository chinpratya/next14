...
export const TagsDetailModal = ({
  ...
  const updateTag = useUpdateTag({
    ...
    onSuccess: () => {
      ...
      showNotification({
        type: 'success',
        message: t(
          'policyManagement.notification.tags.update'
        ) as string,
      });
    },
  });
  ...
  const tabItems: TabsProps['items'] = [
    {
      label: (
        <IntlMessage id="policyManagement.tag.detail" />
      ),
      key: 'detail',
    ...
    {
      label: (
        <IntlMessage id="policyManagement.tag.detail.basicInfo" />
      ),
      key: 'basic',
      children: (
  ...
  return (
    <Modal
      title={
        <>
          <IntlMessage id="policyManagement.tag.detail.title" />{' '}
