    ...
    [
      {
        label: (
          <IntlMessage
            id={tokens.dataBreach.task.general}
          />
        ),
        key: 'general',
        forceRender: true,
      ...
      },
      {
        label: (
          <IntlMessage
            id={tokens.dataBreach.task.requestDetail}
          />
        ),
        key: 'request',
        forceRender: true,
      ...
      },
      {
        label: (
          <IntlMessage
            id={tokens.dataBreach.task.notification}
          />
        ),
        key: 'notification',
        forceRender: true,
      ...
      {
        label: (
          <IntlMessage id={tokens.dataBreach.task.api} />
        ),
        forceRender: true,
        key: 'api',
        children: (
      ...
      },
      {
        label: (
          <IntlMessage
            id={tokens.dataBreach.task.riskAssessment}
          />
        ),
        key: 'riskAssessment',
        disabled: !task?.IdentifyTask,
        children: (
          <TaskWidgetAssessment
            taskId={task?.workID ?? ''}
            isRisk={isRisk}
  ...
  const createTask = useCreateTask({
    ...
    onSuccess: () => {
      ...
      showNotification({
        type: 'success',
        message: t(
          tokens.dataBreach.task.notifications.create
        ) as string,
      });
    },
  });
  ...
  const updateTaskStatus = useUpdateTaskStatus({
    ...
    onSuccess: () => {
      ...
      showNotification({
        type: 'success',
        message: t(
          tokens.dataBreach.task.notifications.update
        ) as string,
      });
    },
  });
  ...
  return (
    <Modal
      title={
        <>
          <IntlMessage
            id={tokens.dataBreach.task.detailTitle}
          />{' '}
