...
import { IndicesForwardSiem } from './indices-forward-siem';
...
export const IndicesList = () => {
  ...
  const onEdit = (indice: Indice, isEditor = false) => {
    router.push({
      pathname: `${router.pathname}/${indice.id}`,
      query: isEditor ? { edit: true } : {},
    });
  };
