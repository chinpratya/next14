...
export const ConsentBuilderRequestTypeSetting = () => {
  ...
  return (
    <Drawer
      ...
      onClose={() => toggleRequestTypeSetting()}
      afterOpenChange={(visible) => {
        if (!visible) {
          form.resetFields();
        }
        if (visible && currentRequestType) {
          form.setFieldsValue(currentRequestType);
        }
      }}
    >
      <Form
