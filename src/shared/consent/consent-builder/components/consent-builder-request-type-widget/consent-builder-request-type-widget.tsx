...
export type ConsentBuilderRequestTypeWidgetProps = {
  component: Record<string, unknown>;
  form?: FormInstance;
  isReadonly?: boolean;
};
export const ConsentBuilderRequestTypeWidget = ({
  component,
  form,
  isReadonly = false,
}: ConsentBuilderRequestTypeWidgetProps) => {
