...
const PreviewIconPage = () => {
  ...
  const gdprCookieNotice = (
    ...
    try {
      ...
      if (popupElement) {
        popupElement.className = `popsetting-onefence-${setting.icon_position} show-onefence`;
      }

      const iconElement = document?.querySelector('img');
      if (iconElement && setting.icon_logo) {
        iconElement.setAttribute(
          'src',
          setting.icon_logo as string
        );
      }
    } catch (error) {
...
export default PreviewIconPage;
